...
function etrigan_scripts() {
	...
	wp_enqueue_style('etrigan-title-font', '//fonts.googleapis.com/css?family='.str_replace(" ", "+", get_theme_mod('etrigan_title_font', 'Lato') ).':100,300,400,700' );
	
	wp_enqueue_style('etrigan-body-font', '//fonts.googleapis.com/css?family='.str_replace(" ", "+", get_theme_mod('etrigan_body_font', 'Open Sans') ).':100,300,400,700' );
...
add_action( 'admin_enqueue_scripts', 'etrigan_custom_wp_admin_style' );
