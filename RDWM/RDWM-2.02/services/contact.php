...
<html lang="en">
	...
	<head>
		...
		<meta name="keywords" content="php contact">
		<meta name="description" content="php for contact form">		
					...
					<div class="row">
						<div class="col-sm-6 col-sm-offset-3">
							<div id="form_response" class="text-center">
								...
								<a class="btn btn-theme btn-lg" href="http://www.reddragonwebmedia.com/services/Phoenix-SEO.html">Back To The Site</a>
							</div>
						</div>	
					</div>					
				</div>
